...
public class LastF_Capitals
{
   public static void main(String[] args)
   {
      ...
      System.out.print( Arrays.toString(statesArray));
      
   } 
 
   public static String displayWord(int tries, int Words, String scrambledCity, String randomState)
   {
      String message = String.format("Tries left %d%nNumber of words %d%nScrambled City %s%n State %s ",tries, Words, scrambledCity, randomState );
